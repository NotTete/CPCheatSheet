...
\begin{center}
\includegraphics[width=25mm]{content/math/sphericalCoordinates} % original 25mm
\end{center}
\[\begin{array}{cc}
...
\section{Circles}
	...
	\kactlimport{Apolonium.h}

\section{Polygons}
	\kactlimport{PointInPolygon.h}
	\kactlimport{IsConvex.h}
	\kactlimport{MaxDistPolToPol.h}
